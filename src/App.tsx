...
import { Difficulties, LevelFilters, Song } from "./types.tsx";
...
function App() {
  ...
  const [recentFilter, setRecentFilter] = useState<Object>({ filter: false });
  ...
  function pullRandom() {
    ...
    //something weird is happening with hypers
...
//store selected picks in a separate array maybe?
